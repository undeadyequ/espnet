...
preprocess_dir=/home/Data/blizzard2013_part_preprocess # Preprocess dir
dumpdir=${preprocess_dir}/dump         # Directory to dump features.
expdir=${preprocess_dir}/exp           # Directory to save experiments.
...
if ! "${skip_train}"; then
    if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
        ...
        log "Stage 5: TTS collect statsStage 5: TTS collect stats: train_set=${_train_dir}, valid_set=${_valid_dir}"
