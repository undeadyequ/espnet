...
class Decoder_extra_input(torch.nn.Module):
    ...
    def __init__(
        ...
        """
        super(Decoder_extra_input, self).__init__()
    ...
    def forward(self, hs, hlens, ys, extra):
        """Calculate forward propagation.
        ...
        Args:
            ...
            extra(Tensor):
                Extract input, concatenated with input, into decoder (B, extra_dim), Teacher-Forcing
    ...
    def inference(
        ...
        Args:
            ...
            extra(Tensor):
                Extract input, concatenated with input, into decoder (extra_dim,).
