...
class ESPnetTTSModel2(AbsESPnetModel):
    def __init__(
        ...
        emofeats_normalize: Optional[AbsNormalize and InversibleInterface],
        tts: AbsTTS,
    ):
        assert check_argument_types()
        super().__init__()
        self.feats_extract = feats_extract
        self.emofeats_extract = emofeats_extract
        self.pitch_extract = pitch_extract
        self.energy_extract = energy_extract
        self.normalize = normalize
        self.pitch_normalize = pitch_normalize
        self.energy_normalize = energy_normalize
        self.emofeats_normalize = emofeats_normalize
        self.tts = tts
    ...
    def forward(
        ...
        **kwargs,
        ...
        with autocast(False):
            ...
            if self.emofeats_extract is not None and emofeats is None:
                pit, eng, jilter = self.emofeats_extract(
                    speech,
                    speech_lengths
                )
